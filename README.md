...
Initial primer trimming was performed by removing 30 nucleotides from both ends of the amplicon using cutadapt with parameters “-u 30 -u -30”. Additional primer trimming was performed using ampliclip (github link) for the long amplicons or by trimming an additional 30 nt at the beginning and end of the read for the short amplicon data. Reads were mapped to the reference genome NC_063383.1 with the parameters “-Y -x map-ont”. For the short amplicons  a truncated version of ON585033.1 (last 6491 nt removed) was used to handle the absence of amplicons in this region for this set. Primers for the long set were softclipped using our custom tool “ampliclip”.  

For the short amplicon protocol, the primer sequences are not publicly available; we assumed that these were the  30 nt flanking regions of the amplicons (amplicon regions were available), which was used as an input for our tool. We used parameters “--padding 10 --mismatch 2 --minlength 1000” for the long and “--minlength 150” for the short amplicon set. 
