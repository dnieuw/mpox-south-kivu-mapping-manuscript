...
``snakemake --snakefile Snakefile_long.smk --directory results_long --config sample_data=sample_data_long.tsv --cores 16``
...
``snakemake --snakefile Snakefile_short.smk --directory results_short --config sample_data=sample_data_short.tsv --cores 16``
...
``snakemake --snakefile Snakefile_combine.smk --directory results_combined --config sample_data=sample_data_combined.tsv --cores 16``
